...
{
    $aux= $_POST['nombre']."-".$_POST['apellido']."-".$_POST['dni']."-".$_POST['sexo']."-".$_POST['sueldo']."-".$_POST['legajo']."-".$_POST['foto'];
    
    $objEmpleado= explode("-",$aux);    

    $empleado = new Empleado($_POST['nombre'], $_POST['apellido'], $_POST['dni'], $_POST['sexo'], $_POST['sueldo'], $_POST['legajo'], $_POST['foto']);
